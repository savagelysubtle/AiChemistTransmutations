...
def check_tesseract():
    ...
    if shutil.which("tesseract"):
        try:
            ...
            return True, f"✅ Tesseract OCR: Available (in PATH)"
...
def check_ghostscript():
        ...
        if Path(path).exists():
            ...
            if sys.platform == "win32":
                ...
                if version_dirs:
                    ...
                    if gs_exe.exists():
                        try:
                            result = subprocess.run([str(gs_exe), "--version"], capture_output=True, text=True, timeout=5)
                            version = result.stdout.split('\n')[0] if result.stdout else "Unknown version"
    ...
    if shutil.which("gswin64c") or shutil.which("gs"):
        ...
        try:
            ...
            return True, f"✅ Ghostscript: Available (in PATH)"
...
def check_libreoffice():
    ...
    if shutil.which("soffice") or shutil.which("libreoffice"):
        ...
        try:
            ...
            return True, f"✅ LibreOffice: Available (in PATH)"
...
def main():
    ...
    if not libreoffice_ok:
        print("ℹ️  LibreOffice is optional but recommended for advanced document conversions")
